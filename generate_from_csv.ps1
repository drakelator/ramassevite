...
<body>
    ...
    <section class="section">
        <div class="container text-center">
            <h2 class="text-center" style="margin-top: 20px;"><span style="background: var(--rvrs-orange); color: black; padding: 0 10px;">Comment ça marche?</span></h2>
            <div class="steps-grid" style="text-align: left;">
                <!-- Step 1 -->
                <div class="step-item reveal-hidden">
                    <h3>
                        <div class="step-number">1</div> Contactez-nous
                    </h3>
                ...
                <div class="step-item reveal-hidden stagger-1">
                    <h3>
                        <div class="step-number">2</div> Nous Estimons
                    </h3>
                    <p>Nous vous donnons le prix le plus compétitif et raisonnable sur le marché.</p>
                </div>
                <!-- Step 3 -->
                <div class="step-item reveal-hidden stagger-2">
                    <h3>
                        <div class="step-number">3</div> Nous Ramassons
                    </h3>
                ...
                <div class="step-item reveal-hidden stagger-3">
                    <h3>
                        <div class="step-number">4</div> Suivi Client 😉
                    </h3>
                    <p>Votre satisfaction est notre priorité, nous nous assurons que tout est parfait.</p>
                </div>
            </div>
        </div>
    </section>
...
<body>
    ...
    <section class="section">
        <div class="container text-center">
            <h2 class="text-center" style="margin-top: 20px;"><span style="background: var(--rvrs-orange); color: black; padding: 0 10px;">How It Works?</span></h2>
            <div class="steps-grid" style="text-align: left;">
                <!-- Step 1 -->
                <div class="step-item reveal-hidden">
                    <h3>
                        <div class="step-number">1</div> Contact Us
                    </h3>
                ...
                <div class="step-item reveal-hidden stagger-1">
                    <h3>
                        <div class="step-number">2</div> We Estimate
                    </h3>
                ...
                <div class="step-item reveal-hidden stagger-2">
                    <h3>
                        <div class="step-number">3</div> We Pick Up
                    </h3>
                ...
                <div class="step-item reveal-hidden stagger-3">
                    <h3>
                        <div class="step-number">4</div> Customer Follow-up 😉
                    </h3>
                    <p>Your satisfaction is our priority, so we will always make sure that is the case.</p>
                </div>
            </div>
        </div>
    </section>
